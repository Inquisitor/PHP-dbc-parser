...
class mysql
{
    ...
    {
        $this->db = $dbname;
        $this->dbhandle = @mysql_pconnect($dbhost, $dbuser, $dbpass) or die($this->dberror());
        @mysql_select_db($this->db, $this->dbhandle) or die($this->dberror());
    ...
    function SwitchDB($newdb)
    {
        ...
        @mysql_select_db($newdb, $this->dbhandle) or die($this->dberror());
    }
